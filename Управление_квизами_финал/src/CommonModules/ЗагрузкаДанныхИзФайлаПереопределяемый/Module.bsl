...
Процедура ПриОпределенииСправочниковДляЗагрузкиДанных(ЗагружаемыеСправочники) Экспорт
	...
	ЗагружаемыеСправочники = ЗагружаемыеСправочники.СкопироватьКолонки();
	
	Сведения = ЗагружаемыеСправочники.Добавить();
	Сведения.ПолноеИмя = Метаданные.Справочники.Вопросы.ПолноеИмя();
	Сведения.Представление = Метаданные.Справочники.Вопросы.Представление();
